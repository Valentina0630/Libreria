...
function CarritoElements() {
    ...
    const eliminarLibroDelCarrito = (e) => {
        ...
        Swal.fire({
            title: '¿Estás seguro?',
            text: `¿Estás seguro de que quieres eliminar ${libroAEliminar.title} (Cantidad: ${libroAEliminar.cantidad})?`,
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire(
                    'Eliminado',
                    `El libro ${libroAEliminar.title} ha sido eliminada del carrito.`,
                    'success'
                );
            }
        });
